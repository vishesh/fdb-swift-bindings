...
public enum NetworkOption: UInt32 {
	...
	public static let localAddress = NetworkOption(rawValue: 10)

	@available(*, deprecated)
	public static let clusterFile = NetworkOption(rawValue: 20)
...
public enum TransactionOption: UInt32 {
	...
	@available(*, deprecated)
	public static let readAheadDisable = TransactionOption(rawValue: 52)
	...
	@available(*, deprecated)
	public static let durabilityDevNullIsWebScale = TransactionOption(rawValue: 130)
...
public enum MutationType: UInt32 {
	...
	@available(*, deprecated)
	public static let and = MutationType(rawValue: 6)
	...
	@available(*, deprecated)
	public static let or = MutationType(rawValue: 7)
	...
	@available(*, deprecated)
	public static let xor = MutationType(rawValue: 8)
